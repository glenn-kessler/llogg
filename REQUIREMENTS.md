...
| Yes  | F-4.12    | Datenüberprüfung & Visualisierung            | Automatische Schrittgröße basierend auf Zeitspanne (1 Tag → 3h Schritte, 2-7 Tage → 1 Tag, 2-4 Wochen → KW, 2-6 Monate → Monate). Monat wird als zweite Zeile angezeigt. |
...
| Yes  | F-4.19    | Datenüberprüfung & Visualisierung            | Zeitbereichs-Navigation mit Pfeil-Buttons (← →) ermöglicht Verschiebung des Datenbereichs um jeweils 1 Zeitspannen-Inkrement vor/zurück. Zeitspannen-Wert und -Einheit getrennt steuerbar. |
| ---  | ---       | ---                                          | ---                                                                                                                                                                      |
