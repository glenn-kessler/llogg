...
| Yes  | F-4.6     | Datenüberprüfung & Visualisierung            | Zeitspannen-Auswahl via Dropdown-Selektoren für Wert (1-100) und Einheit (Stunden/Tage/Wochen/Monate/Jahre). Ohne Minuten im MVP.                                        |
...
| Yes  | F-4.12    | Datenüberprüfung & Visualisierung            | Automatische Schrittgröße basierend auf Zeitspanne (1 Tag → 3h Schritte, 2-7 Tage → 1 Tag, 2-4 Wochen → KW, 2-6 Monate → Monate). Mehrzeilige Labels mit präziser Monatsausrichtung: Bei Stunden wird Tag.Monat nur bei Tageswechsel angezeigt (z.B. "22 23 0 1\n1.Jan 2.Jan"). Bei Tagen/Wochen erscheint Monat nur am letzten Tag/KW des Monats, exakt am jeweiligen Tag/KW ausgerichtet (z.B. "Mo Di Mi Do Fr\nJan" wenn Fr der letzte Tag im Januar ist, oder "KW1 KW2 KW3\nJan Feb" mit Jan am KW3 und Feb am ersten KW des Februar). |
...
| Yes  | F-4.12.2  | Datenüberprüfung & Visualisierung            | Zeitachsen-Beschriftung zeigt Wochentags-Abkürzungen bei Tages-Schritten (Mon, Tue, etc.) und Kalenderwochen-Format bei Wochen-Schritten (KW1, KW2, etc.).               |
...
| Yes  | F-4.19    | Datenüberprüfung & Visualisierung            | Aufgeteilte Steuerung: "Time Span" mit zwei Dropdown-Selektoren für [Wert] und [Einheit] (z.B. [7][Days]). "Time Range" mit Pfeil-Buttons (← [Offset] →) zur Verschiebung des Zeitbereichs vor/zurück. Offset zeigt Anzahl der Zeitspannen-Verschiebung. Änderung von Time Span setzt Offset auf 0 zurück. |
| ---  | ---       | ---                                          | ---                                                                                                                                                                      |
